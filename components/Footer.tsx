...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 dark:text-white pt-20 pb-8 lg:pt-[120px] lg:pb-16 max-lg:px-5 border-t border-primary">
      <div className="container mx-auto">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="w-full mb-10">
              <div className="flex items-center mb-5 space-x-3 cursor-pointer">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="w-full mb-10">
              <h2 className="text-lg font-semibold text-dark mb-9">Resources</h2>
              <ul>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Development</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Our Products</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">User Flow</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">User Strategy</a></li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="w-full mb-10">
              <h2 className="text-lg font-semibold text-dark mb-9">Company</h2>
              <ul>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">About</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Contact & Support</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Success History</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Setting & Privacy</a></li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="w-full mb-10">
              <h2 className="text-lg font-semibold text-dark mb-9">Quick Links</h2>
              <ul>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Premium Support</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Our Services</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Know Our Team</a></li>
                <li><a href="#" className="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Download App</a></li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="w-full mb-10">
              <h2 className="text-lg font-semibold text-dark mb-8">Follow Us On</h2>
              <div className="flex items-center mb-6">
                <Link title='facebook' href="https://www.facebook.com/modernfuture00" target="_blank" className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                ...
                <Link title='twitter' href="https://twitter.com/ZYYOGi" target="_blank" className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                ...
                <Link title='youtube' href="https://www.youtube.com/channel/UC-KXAtzzHgsx1e1P78W9SNQ" target="_blank" className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                  <svg height="18" viewBox="0 0 16 12" fill='currentColor'>
                    <path d="M15.6645 1.88018C15.4839 1.13364 14.9419 0.552995 14.2452 0.359447C13.0065 6.59222e-08 8 0 8 0C8 0 2.99355 6.59222e-08 1.75484 0.359447C1.05806 0.552995 0.516129 1.13364 0.335484 1.88018C0 3.23502 0 6 0 6C0 6 0 8.79263 0.335484 10.1198C0.516129 10.8664 1.05806 11.447 1.75484 11.6406C2.99355 12 8 12 8 12C8 12 13.0065 12 14.2452 11.6406C14.9419 11.447 15.4839 10.8664 15.6645 10.1198C16 8.79263 16 6 16 6C16 6 16 3.23502 15.6645 1.88018ZM6.4 8.57143V3.42857L10.5548 6L6.4 8.57143Z" />
                  </svg>
                </Link>
                <Link title='linkedin' href="https://www.linkedin.com/in/youssef-amjad-340b07256/" target="_blank" className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
              ...
              <p className="text-base text-body-color">&copy; 2023 All rights reserved for Future Schools</p>
            </div>
          </div>
        </div>
      </div>
